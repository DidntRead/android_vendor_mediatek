...
#define LOG_TAG "audiohalservice_mtk"
...
int main(int /* argc */, char* /* argv */ []) {
    ...
    bool fail = registerPassthroughServiceImplementation<audio::V2_0::IDevicesFactory>() != OK;
    LOG_ALWAYS_FATAL_IF(fail, "Could not register audio core API 2.0");
