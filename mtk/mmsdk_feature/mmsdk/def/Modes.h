...
#ifndef _MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_DEF_MODES_H_
#define _MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_DEF_MODES_H_
...
#endif  //_MTK_HARDWARE_MTKCAM_INCLUDE_MTKCAM_DEF_MODES_H_
