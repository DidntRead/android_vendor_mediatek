...
public final class MMTelSSTransport {
    ...
    private boolean updateNetworkInitSimServ(int phoneId) {
        ...
        if (TextUtils.isEmpty(mXcapRoot)) {
            Rlog.d(LOG_TAG, "updateSimServParameter(): XcapRoot = " + mXcapRoot);
    ...
    class MMTelSSTransmitter extends Handler implements Runnable {
        ...
        public boolean containSpecificMedia(List<String>mediaList, int serviceClass, int phoneId) {
            ...
            if (MMTelSSUtils.isOp19IccCard(phoneId)) {
                boolean isWithVideo = false;
                boolean isWithAudio = false;
                ...
                Rlog.d(LOG_TAG, "isWithVideo =" + isWithVideo);
                Rlog.d(LOG_TAG, "isWithAudio =" + isWithAudio);

                if ((serviceClass == CommandsInterface.SERVICE_CLASS_VIDEO
                    || serviceClass == CommandsInterface.SERVICE_CLASS_NONE)
                    && isWithVideo) {
                    return true;
                } else if ((serviceClass == CommandsInterface.SERVICE_CLASS_VOICE
                    || serviceClass == CommandsInterface.SERVICE_CLASS_NONE)
                    && (!isWithVideo && isWithAudio)) {
                    return true;
                }
        ...
        public boolean hasExtraMedia(List<String>mediaList, int serviceClass, int phoneId) {
            boolean found = false;
            found = containSpecificMedia(mediaList, serviceClass, phoneId);
        ...
        public boolean isBAOC(Conditions cond, int serviceClass, int phoneId) {
            ...
            if (cond.comprehendInternational() == false
                    ...
                    && containSpecificMedia(cond.getMedias(), serviceClass, phoneId)) {
                return true;
            } else {
                return false;
            }
        ...
        public boolean isBAIC(Conditions cond, int serviceClass, int phoneId) {
            //If the <cp:conditions></cp:conditions> is empty, the result of <cp:condition> is
            // evaluated as true
            if (cond == null)
                return true;
        ...
        public void handleGetCLIR(MMTelSSRequest rr) {
            ...
            Rlog.d(LOG_TAG, "handleGetCLIR() reqNo = " + reqNo
                    +" serialNo = "+serialNo+" phoneId = " + phoneId);
            ...
            try {
                ...
                if ((mOirCache != null) && (phoneId == mOirCachePhoneId) &&
                    ...
                    if (!updateNetworkInitSimServ(phoneId)) {
        ...
        public void handleGetCLIP(MMTelSSRequest rr) {
            ...
            serialNo = rr.mp.readInt();
            int phoneId = rr.mp.readInt();
            Rlog.d(LOG_TAG, "handleGetCLIP() reqNo = " + reqNo
                    +" serialNo = "+serialNo+" phoneId = " + phoneId);
            if (!MMTelSSUtils.isPreferXcap(phoneId)) {
        ...
        public void handleGetCOLP(MMTelSSRequest rr) {
            ...
            serialNo = rr.mp.readInt();
            int phoneId = rr.mp.readInt();
            Rlog.d(LOG_TAG, "handleGetCOLP() reqNo = " + reqNo
                    +" serialNo = "+serialNo+" phoneId = " + phoneId);
        ...
        public void handleGetCOLR(MMTelSSRequest rr) {
            ...
            serialNo = rr.mp.readInt();
            int phoneId = rr.mp.readInt();
            Rlog.d(LOG_TAG, "handleGetCOLR() reqNo = " + reqNo
                    +" serialNo = "+serialNo+" phoneId = " + phoneId);
                        ...
                        for (int it = 0; it < num_of_comparision; it++) {
                            ...
                            for (int i = 0; i < ruleList.size(); i++) {
                                ...
                                if ((cond != null && cond.comprehendInternational()) &&
                                        cBFacility.equals(CommandsInterface.CB_FACILITY_BAOIC) &&
                                        containSpecificMedia(mediaList, cbServiceClass, phoneId)) {
                                ...
                                } else if (isBAOC(cond, cbServiceClass, phoneId) &&
                    ...
                    if (ruleList != null) {
                        for (int it = 0; it < num_of_comparision; it++) {
                            ...
                            for (int i = 0; i < ruleList.size(); i++) {
                                ...
                                } else if (isBAIC(cond, cbServiceClass, phoneId) &&
                        ...
                        for (int it = 0; it < num_of_comparision; it++) {
                            ...
                            for (int i = 0; i < ruleList.size(); i++) {
                                ...
                                if (cfAction == 2
                                        ...
                                        && containSpecificMedia(mediaList, serviceClass, phoneId)) {
        ...
        public boolean handleCreateNewRuleForExistingCF(CommunicationDiversion cd,
                ...
                boolean updateSingleRule, int numExpansion, int phoneId, List<String> mediaList) throws XcapException {
            Conditions cond = r.getConditions();
            Actions action = r.getActions();
            ...
            if (setCFAction == CommandsInterface.CF_ACTION_ENABLE
                ...
                if (MMTelSSUtils.isOp19IccCard(phoneId)) {
                    if (mediaList != null) {
                        for (int i = 0; i < mediaList.size(); i++) {
                            Rlog.d(LOG_TAG, "add media tag: " + mediaList.get(i));
                            cfCond.addMedia(mediaList.get(i));
                        }
                    }
                } else if (!MMTelSSUtils.isOp03IccCard(phoneId)
                    ...
                    if (setCFServiceClass == CommandsInterface.SERVICE_CLASS_VOICE) {
                        ...
                        Rlog.d(LOG_TAG, "if op01,do not add video!");
                        cfCond.addMedia("audio");
                ...
                } else if (hasExtraMedia(cond.getMedias(), setCFServiceClass, phoneId)) {
                    if (updateSingleRule && (1 == numExpansion)) {
        ...
        public Rule copyOldRuleToNewRuleSetExceptSpecificMedia(Rule oldRule, RuleSet newRuleSet,
            ...
            if (oldCond != null &&
                    hasExtraMedia(oldCond.getMedias(), requestedServiceClass, phoneId) == false) {
        ...
        public int handleSetCF(MMTelSSRequest rr) {
            ...
            try {
                ...
                for (int it = 0; it < num_of_expansion; it++) {
                    ...
                    if (ruleList != null) {
                        ...
                        for (int i = 0; i < ruleList.size(); i++) {
                            ...
                            if (setCFReason == CommandsInterface.CF_REASON_BUSY &&
                                    (cond != null && cond.comprehendBusy() == true) &&
                                    containSpecificMedia(mediaList, setCFServiceClass, phoneId)) {
                                ...
                                if ((setCFServiceClass != CommandsInterface.SERVICE_CLASS_NONE) ||
                                    ...
                                    addedNewRule = handleCreateNewRuleForExistingCF(cd, newRuleSet,
                                            ...
                                            mUpdateSingleRule, num_of_expansion, phoneId, mediaList);
                                ...
                                if ((setCFServiceClass != CommandsInterface.SERVICE_CLASS_NONE)
                                    ...
                                    if ((setCFServiceClass ==
                                            CommandsInterface.SERVICE_CLASS_NONE)
                                            && (!MMTelSSUtils.isOp01IccCard(phoneId))) {
                ...
                if (MMTelSSUtils.isOp05IccCard(phoneId)
                    ...
                    infos = parseCFUInfoFromCD(cd, setCFReason, setCFServiceClass, phoneId);
                }
        ...
        private CallForwardInfo[] parseCFUInfoFromCD(CommunicationDiversion cd,
            int cfReason, int cfServiceClass, int phoneId) {
                        ...
                        if (ruleList != null) {
                            for (int i = 0; i < ruleList.size(); i++) {
                                ...
                                if (facility.equals(CommandsInterface.CB_FACILITY_BAOIC) &&
                                        ...
                                        containSpecificMedia(mediaList, setCBServiceClass, phoneId)) {
                                    ...
                                    if ((setCBServiceClass != CommandsInterface.SERVICE_CLASS_NONE)
                                        ...
                                        isBAOC(cond, setCBServiceClass, phoneId)) {
                            ...
                            for (int i = 0; i < ruleList.size(); i++) {
                                ...
                                if (facility.equals(CommandsInterface.CB_FACILITY_BAICr) &&
                                    ...
                                    if ((setCBServiceClass != CommandsInterface.SERVICE_CLASS_NONE)
                                        ...
                                        isBAIC(cond, setCBServiceClass, phoneId) &&
                                        containSpecificMedia(mediaList, setCBServiceClass, phoneId)) {
                            ...
                            if ((setCFServiceClass != CommandsInterface.SERVICE_CLASS_NONE) ||
                                ...
                                if (setCFAction == CommandsInterface.CF_ACTION_ENABLE ||
                                    ...
                                    addedNewRule = handleCreateNewRuleForExistingCF(
                                            ...
                                            setCFServiceClass, setCFNumber, setCFTimeSeconds,
                                            cfuRuleID, mUpdateSingleRule, 1, phoneId, mediaList);
                                }
