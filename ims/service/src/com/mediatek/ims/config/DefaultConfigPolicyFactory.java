...
public class DefaultConfigPolicyFactory {
    ...
    public static DefaultConfigPolicyFactory getInstance(int phoneId) {
        ...
        return getInstance(optr);
    }

    public static DefaultConfigPolicyFactory getInstance(String op) {
        return new DefaultConfigPolicyFactory(op);
    }

    private DefaultConfigPolicyFactory(String op) {
