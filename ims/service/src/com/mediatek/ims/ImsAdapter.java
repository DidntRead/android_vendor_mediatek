                    ...
                    try {
                        if (mDin != null) {
                            ...
                            synchronized (ImsEnabledThreadLock) {
                                if ((event != null) && (misImsAdapterEnabled == true)) {
                        ...
                        Log.d("@M_" + TAG, "VaSocketIO(): InterruptedIOException");
                        e.printStackTrace();

                        Log.d("@M_" + TAG, "MAL socket disconnect");
                        disconnectSocket();
                        disableImsAdapter(false);
                    } catch (Exception e) {
                        Log.d("@M_" + TAG, "VaSocketIO(): Exception");
                        e.printStackTrace();
...
//    private static final String SOCKET_NAME2 = "volte_imsa2";
    ...
    public void handleMessage(Message msg) {
        Log.d("@M_" + TAG, "handleMessage():" + msg.what +
               ", misImsAdapterEnabled = " + misImsAdapterEnabled);

        switch (msg.what) {
            // Not used case now
            case MSG_IMSA_RETRY_CONNECT_SOCKET:
                synchronized (ImsEnabledThreadLock) {
                    if (misImsAdapterEnabled == true) {
                        if (mIO.connectSocket() == true) {
                            Log.d("@M_" + TAG, "RETRY_CONNECT_SOCKET: connectSocket success");

                        }
                        else {
                            sendMessageDelayed(
                                    obtainMessage(MSG_IMSA_RETRY_CONNECT_SOCKET),
                                    IMSA_RETRY_SOCKET_TIME);
                        }
                    }
                }
...
*/
    ...
    public static String requestIdToString(int requestId) {
        switch (requestId) {
            case 900001: return "MSG_ID_WRAP_IMSPA_IMSM_INFORMATION_IND";
            case 900002: return "MSG_ID_WRAP_IMSM_IMSPA_INFORMATION_REQ";
            case 900003: return "MSG_ID_IMS_ENABLE_IND";
            case 900004: return "MSG_ID_IMS_DISABLE_IND";

            case 900008: return "MSG_ID_WRAP_IMSM_IMSPA_PDN_ACT_REQ";
            case 900009: return "MSG_ID_WRAP_IMSPA_IMSM_PDN_ACT_ACK_RESP";
            case 900010: return "MSG_ID_WRAP_IMSPA_IMSM_PDN_ACT_REJ_RESP";
            case 900011: return "MSG_ID_WRAP_IMSM_IMSPA_PDN_DEACT_REQ";
            case 900012: return "MSG_ID_WRAP_IMSPA_IMSM_PDN_DEACT_ACK_RESP";
            case 900013: return "MSG_ID_WRAP_IMSPA_IMSM_PDN_DEACT_REJ_RESP";
            case 900014: return "MSG_ID_WRAP_IMSPA_IMSM_PDN_DEACT_IND";

            /* timer */
            case 900201: return "MSG_ID_REQUEST_TIMER_CREATE";
            case 900202: return "MSG_ID_REQUEST_TIMER_CANCEL";
            case 900203: return "MSG_ID_NOTIFY_TIMER_EXPIRY";

            /* others */
            case 900401: return "MSG_ID_NOTIFY_XUI_IND";
            case 900402: return "MSG_ID_NOTIFY_SS_PROGRESS_INDICATION";
            case 900403: return "MSG_ID_REQUEST_PCSCF_DISCOVERY";
            case 900404: return "MSG_ID_RESPONSE_PCSCF_DISCOVERY";
            case 900405: return "MSG_ID_REJECT_PCSCF_DISCOVERY";
